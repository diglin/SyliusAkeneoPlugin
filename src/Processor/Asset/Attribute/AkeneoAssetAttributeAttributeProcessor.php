...
{
    private $assetValueBuilderProvider;

    private $akeneoAssetFactory;

    private $akeneoAssetRepository;

    private $entityManager;

    private $akeneoAssetAttributeDataProvider;
    ...
    private function handleAsset(
        ...
        $asset->setContent($assetAttributeValue);
    }
}
